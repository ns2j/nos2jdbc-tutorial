...
@Generated(value = {"NOS2JDBC-Gen unknown", "org.seasar.extension.jdbc.gen.internal.model.SqlFileTestModelFactoryImpl"}, date = "2017/08/25 15:32:23")
public class SqlFileTest {
    ...
    public void testSqlFile0() throws Exception {
        String path = "sql/select_club.sql";
